...
## Project Structure
    ...
    ├── testapiautocatalog_125337  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_125337`
...
2. Clone this repo and `cd testapiautocatalog_125337`
